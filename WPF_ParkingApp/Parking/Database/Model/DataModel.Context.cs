...
namespace Parking.Database.Model
{
    ...
    public partial class ParkingEntities : DbContext
    {
        ...
        public virtual DbSet<ParkingSpacesAdministrator> ParkingSpacesAdministrators { get; set; }
        public virtual DbSet<ParkingSpacesOwner> ParkingSpacesOwners { get; set; }
    }
}
