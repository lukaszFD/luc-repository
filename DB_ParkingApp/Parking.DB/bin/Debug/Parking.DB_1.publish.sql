...
GO
PRINT N'Altering [parking].[usp_AddParkingSpaces]...';


GO


ALTER PROC [parking].[usp_AddParkingSpaces]
(
   @ownerId INT 
  ,@date_start DATE
  ,@date_end DATE 
...
GO
PRINT N'Altering [parking].[usp_ParkingSpacesOwners_Delete]...';


GO

ALTER PROC [parking].[usp_ParkingSpacesOwners_Delete]
(
 @OwnerID INT 
)
AS
...
GO
PRINT N'Creating [dbo].[usp_BlackoutDates_AddNew]...';


GO
CREATE PROCEDURE [dbo].[usp_BlackoutDates_AddNew]
(
	@date Date 
)
...
VALUES 
	(@date)
GO
PRINT N'Creating [dbo].[usp_BlackoutDates_Delete]...';


GO
CREATE PROCEDURE [dbo].[usp_BlackoutDates_Delete]
(
	@date Date 
)
AS
